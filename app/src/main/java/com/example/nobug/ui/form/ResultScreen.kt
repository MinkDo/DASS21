package com.example.nobug.ui.form
    ...
    Column(
        ...
        Row(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
                ...
                Text(text = "Form", color = MaterialTheme.colorScheme.primary)
                Text(text = "Analysis", color = MaterialTheme.colorScheme.primary)
            }
        }
